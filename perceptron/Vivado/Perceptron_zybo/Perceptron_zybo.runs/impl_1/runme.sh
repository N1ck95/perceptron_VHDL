...
HD_PWD='C:/Users/4r35/Documents/Universita/Semestre2/Digital_Systems/LAB/Modelsim/perceptron/Vivado/Perceptron_zybo/Perceptron_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log perceptron_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source perceptron_wrapper.tcl -notrace
