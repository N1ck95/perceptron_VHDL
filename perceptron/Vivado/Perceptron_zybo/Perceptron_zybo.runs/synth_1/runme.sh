...
HD_PWD='C:/Users/4r35/Documents/Universita/Semestre2/Digital_Systems/LAB/Modelsim/perceptron/Vivado/Perceptron_zybo/Perceptron_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log perceptron_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source perceptron_wrapper.tcl
